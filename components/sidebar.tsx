...
import { ArrowLeftRight, CalendarDays, Combine, Upload, LandPlot, LayoutDashboard, Ship, Truck, Users, Warehouse } from "lucide-react";
            ...
            <div className="px-3 py-2  flex-1 text-center mr-auto ml-auto">
                ...
                <div className="space-y-2 ">
                    {routes.map((route, index) => (
                        ...
                        style={{
                            marginTop: index === 1 ? "1.2rem" : index === 8 ? "1.2rem" : ".5rem" 
                        }}
                    >
